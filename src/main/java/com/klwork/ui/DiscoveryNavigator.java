...
public class DiscoveryNavigator extends Navigator implements ViewCacheContainer
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2751133993915041360L;
    ...
    /**
     * 查找spring中的所有配置文件，找出包含VaadinView的注解,将其放到缓存中
     */
    ...
    {	
    	//SpringViewProvider提供视图从cache中取出
