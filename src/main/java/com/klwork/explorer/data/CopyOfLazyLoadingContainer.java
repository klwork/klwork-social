 ...
 */
package com.klwork.explorer.data;
 ...
 * @author Joram Barrez
 */
public class CopyOfLazyLoadingContainer implements Container.Indexed, Container.Sortable{
  ...
  public CopyOfLazyLoadingContainer(LazyLoadingQuery lazyLoadingQuery, int batchSize) {
    this.lazyLoadingQuery = lazyLoadingQuery;
    this.batchSize = batchSize;
    //lazyLoadingQuery.setLazyLoadingContainer(this);
  }
  
  public CopyOfLazyLoadingContainer(LazyLoadingQuery lazyLoadingQuery) {
