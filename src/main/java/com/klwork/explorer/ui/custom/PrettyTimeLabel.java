...
public class PrettyTimeLabel extends Label {
	 ...
	 *            shown when null.
	 */
	public PrettyTimeLabel(String labelTemplate, Date date,
			String noDateCaption, boolean showTime) {
	...
	protected void init() {
		...
		final I18nManager i18nManager = ViewToolManager.getI18nManager();
		if (date != null) {
			...
			if (labelTemplate != null) {
				super.setValue(MessageFormat.format(labelTemplate,
						new HumanTime(i18nManager).format(date)));
			} else {
