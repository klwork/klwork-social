...
import com.klwork.explorer.ui.content.GenericAttachmentRenderer;
import com.klwork.explorer.ui.mainlayout.ExplorerLayout;
import com.klwork.explorer.ui.util.InputStreamStreamSource;
import com.klwork.explorer.util.ImageUtil;
...
public class ImageAttachmentRenderer extends GenericAttachmentRenderer {
  ...
  public Component getDetailComponent(Attachment attachment) {
    ...
    Label fullSizeLabel = new Label(ViewToolManager.getI18nManager().getMessage(Messages.RELATED_CONTENT_SHOW_FULL_SIZE));
