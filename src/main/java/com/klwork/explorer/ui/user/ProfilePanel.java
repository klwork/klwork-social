...
import com.klwork.explorer.ui.custom.InMemoryUploadReceiver;
...
public class ProfilePanel extends Panel {
  ...
  public ProfilePanel(String userId) {
    this.userId = userId;
    this.isCurrentLoggedInUser = userId.equals(LoginHandler.getLoggedInUser().getId());
  ...
  protected void initUi() {
    ...
    emptySpace.setWidth(50, Unit.PIXELS);
  ...
  protected Label createProfileHeader( String headerName) {
